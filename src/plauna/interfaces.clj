...
(defprotocol DB
  ...
  (fetch-distinct-subjects [this] "Get every distinct, non-blank e-mail subject (capped, see distinct-value-limit).")
  (fetch-distinct-senders [this] "Get every distinct sender contact (capped, see distinct-value-limit).")
  (fetch-distinct-recipients [this] "Get every distinct 'To' recipient contact (capped, see distinct-value-limit).")
